This file is the baseline code for 1st and Future - Player Contact Detection--Detect Player Contacts from Sensor and Video Data

以上文件是1st and Future - Player Contact Detection--Detect Player Contacts from Sensor and Video Data（球员接触检测大赛）比赛的baseline代码
